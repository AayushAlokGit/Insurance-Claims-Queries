...
3. **`./design-decisions.md`** — numbered, accepted design decisions (**DD-001 … DD-015**). Each entry has a rationale and what it commits us to. If a fresh idea conflicts with one of these, the DD wins until explicitly re-litigated.
