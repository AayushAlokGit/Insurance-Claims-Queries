...
STATUS:
- attended  — the visit happened. A medical-record block (`Date of Appointment: X` or `DOS: X` followed by clinical content) ALWAYS counts as attended even without an "attended" verb, and even when the note's opening line is a records-receipt notice or other administrative preamble (e.g. `Note: TCM received medical records. Reviewed and saved to file.` followed by `---Date of Appointment:` and a clinical block). The preamble is about how the record arrived; the templated block IS the visit and MUST be emitted. "Clinical content" includes ANY of these section labels: `Plan:`, `Subjective:`, `Objective:`, `Assessment:`, `Assessment/Diagnosis:`, `Diagnosis:`, `Diagnosis & Assessment:`, `FCE Summary:`, `EMG/NCS report:`, `Interpretation:`, `Operative Note:`, `Therapeutic Exercise:`, `Discharge Summary:`, `Findings:`, `Impression:`, or any free-text paragraph describing what happened at the visit.
